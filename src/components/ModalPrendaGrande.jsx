    ...
    >
      ...
      >
        ...
        <div style={{ width: '100%', aspectRatio: '1/1', borderRadius: '20px', overflow: 'hidden', backgroundColor: '#f4f4f5', display: 'flex', justifyContent: 'center', alignItems: 'center', position: 'relative' }}>
          ...
          <div style={{ position: 'absolute', bottom: '15px', right: '15px', width: '26px', height: '26px', borderRadius: '50%', backgroundColor: prenda.color, border: '2px solid #fff', boxShadow: '0 4px 8px rgba(0,0,0,0.2)' }} />
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-around', backgroundColor: '#f2f2f7', padding: '15px', borderRadius: '16px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <span style={{ fontSize: '14px', color: '#111', fontWeight: '600' }}>{prenda.categoria}</span>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <span style={{ fontSize: '14px', color: '#111', fontWeight: '600' }}>{prenda.colorPadre}</span>
          </div>
        </div>
      </div>
    </div>
